...
import { PRODUCTS, STRATEGIEGESPRAECH_URL } from "@/lib/products";
  ...
  return (
    <main className="min-h-dvh bg-[var(--bg)]">
      ...
      <motion.section
        ...
        variants={stagger}
        className="mx-auto w-full max-w-[640px] px-5 pb-6"
      >
        <motion.h2
          variants={fadeUp}
          className="mb-4 text-center text-[11px] font-bold uppercase tracking-[2.5px] text-[var(--text-subtle)]"
        >
          Die 5 Phasen, um dir die ortsunabhängige Selbstständigkeit aufzubauen
        </motion.h2>
