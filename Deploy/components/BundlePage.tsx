...
function CTAButton({ size = "md" }: { size?: "md" | "lg" }) {
  ...
  const ctaLabel = BUNDLE.digistoreUrl
    ? "Jetzt Komplettpaket sichern — 197 €"
    : "Bald verfügbar — Link folgt";
  const ctaDisabled = !BUNDLE.digistoreUrl;
    ...
    <main className="min-h-dvh bg-[var(--bg)]">
      ...
      >
        <div className="rounded-2xl border-2 border-[#1663de]/30 bg-gradient-to-br from-[#1663de]/[0.08] to-[#db6f16]/[0.08] p-6 sm:p-8">
          ...
          <p className="mt-3 text-center text-xs text-[var(--text-subtle)]">
            Sichere Zahlung über Digistore24 · MwSt automatisch · 14-Tage Geld-zurück
          </p>
        </div>
      </motion.section>
