/**
 * POST /api/angebot/delete — Angebot löschen (login-geschützt).
 * Eine evtl. erzeugte Rechnung bleibt erhalten (angebot_id wird gelöst).
 * Body: { id }
 */
...
import { deleteAngebot, dbReady } from "@/lib/angebot/db";
...
export async function POST(req: NextRequest) {
  ...
  const ok = await deleteAngebot(body.id);
