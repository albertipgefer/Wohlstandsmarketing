/**
 * POST /api/finanzen/ausgabe/delete — Ausgabe löschen (login-geschützt).
 * Body: { id }
 */
...
import { deleteAusgabe, dbReady } from "@/lib/finanzen/ausgaben";
...
export async function POST(req: NextRequest) {
  ...
  const ok = await deleteAusgabe(body.id);
