...
import { emailMarketingStadt } from "@/content/standortServices";
...
export async function generateMetadata({
  ...
  if (!city) return {};
  return emailMarketingStadt.meta(city);
}
...
export default async function Page({
  ...
  const city = getCity(stadt);
  if (!city) notFound();
  return <ServiceStadtPage city={city} config={emailMarketingStadt} />;
}
